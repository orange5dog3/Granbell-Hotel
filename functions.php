...
/**
 * TriangleアイコンのSVGを取得する関数
 * 
 * @param string $className 追加したいクラス名（例: "text-red"）
 * @return string SVGタグのHTML
 */
function get_icon_triangle($className = '') {
    // クラス名がある場合はスペースを空けて追加
    $classAttr = $className ? ' ' . $className : '';
    
    return <<<HTML
<svg class="icon-triangle{$classAttr}" width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
